...
export default function Home() {
  return (
    <div className="w-full p-6 lg:px-12 flex flex-col lg:flex-row items-center justify-center gap-10 max-w-full overflow-hidden min-h-[calc(100dvh-80px)]">
      <div className="flex flex-col flex-1 justify-center items-center lg:items-start text-center lg:text-left my-5 max-w-2xl w-full">
