                ...
                <li className="row-span-3">
                  <NavigationMenuLink asChild>
                    <Link
                      ...
                      href="/work/mern"
                    >
                      <div className="mb-2 mt-4 text-lg font-bold">MERN</div>
                      <p className="text-sm leading-tight">
                        Profissional website built using React js (vite js, next
                        js) and node js.
                      </p>
                    </Link>
                  </NavigationMenuLink>
      ...
      <div className="md:hidden absolute right-3 top-2">
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            ...
            <DropdownMenuSeparator />
            <DropdownMenuItem>
              <Link href="/work/mern">MERN</Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/work/frontend">Front-end</Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/work/backend">Back-end</Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/work/flutter">Flutter</Link>
            </DropdownMenuItem>
            <DropdownMenuItem>
              <Link href="/work/wordpress">Wordpress</Link>
            </DropdownMenuItem>
            <DropdownMenuSeparator className="bg-primary" />
            <DropdownMenuItem>
              <Link href="/contact" legacyBehavior passHref>
